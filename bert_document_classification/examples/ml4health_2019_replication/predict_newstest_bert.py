...
from bert_document_classification.models import NewstestBert

log = logging.getLogger()

if __name__ == "__main__":

    newstest_bert = NewstestBert(model_name="/notebook/nas-trainings/arne/OCCAM/text_classification_BERT/code_BERT/bert_document_classification/examples/ml4health_2019_replication/results_newstest_single_gpu_lstm_batch_size10_unfreeze_last_layers/run_2020_03_11_13_02_42_f3f33a8bb1ff/checkpoint_250", device='cuda:1') #CPU prediction (change to 'cuda' if possible)
